...
export default function SelectInput({
  ...
  const customStyles: StylesConfig = {
    control: (styles) => ({
      ...styles,
      border: `1px solid ${error ? "#60a6fa" : "#6b7280"}`, // blue-500 : gray-500
      "&:hover": {
        border: `1px solid ${error ? "#60a6fa" : "#111827"}`, // blue-500 : gray-900
        boxShadow: "inset 0 0 0 1px #111827",
      },
      boxShadow: `${error ? "inset 0 0 0 1px #60a6fa" : "none"}`,
      transition: "all 300ms",
      "&:focus-within": {
        border: `1px solid ${error ? "#60a6fa" : "#111827"}`, // blue-500 : gray-900
        boxShadow: `0 0 0 1px ${error ? "#60a6fa" : "#111827"}`, // blue-500 : gray-900
      },
      "*": {
      ...
      padding: "0 0.75rem",
      background:
        disabled || readOnly ? "#F3F4F6" : `${error ? "#FEE2E2" : "#f8fafc"}`, // light gray : blue-200 : slate-50
      cursor: "pointer",
